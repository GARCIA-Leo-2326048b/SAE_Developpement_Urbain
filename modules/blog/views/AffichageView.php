    ...
    function show($filesData): void
    {
        ...
        <div id="simulationPopup" class="popup" style="display: none; position: fixed; top: 10%; left: 10%; width: 80%; height: 80%; background: #fff; overflow: auto; z-index: 1000;">
            ...
            <div>
                ...
                <input type="range" id="neighbours_l_min" name="neighbours_l_min" min="0" max="100" step="1">
            </div>
            <div>
                <label for="neighbours_l_0">Neighbours L 0</label>
                <input type="range" id="neighbours_l_0" name="neighbours_l_0" min="0" max="100" step="1">
            </div>
            <div>
                <label for="neighbours_l_max">Neighbours L Max</label>
                <input type="range" id="neighbours_l_max" name="neighbours_l_max" min="0" max="100" step="1">
            </div>
            <div>
                <label for="neighbours_w">Neighbours W</label>
                <input type="range" id="neighbours_w" name="neighbours_w" min="0" max="100" step="1">
            </div>
            <div>
                <label for="roads_l_min">Roads L Min</label>
                <input type="range" id="roads_l_min" name="roads_l_min" min="0" max="100" step="1">
            </div>
            <div>
                <label for="roads_l_0">Roads L 0</label>
                <input type="range" id="roads_l_0" name="roads_l_0" min="0" max="100" step="1">
            </div>
            <div>
                <label for="roads_l_max">Roads L Max</label>
                <input type="range" id="roads_l_max" name="roads_l_max" min="0" max="100" step="1">
            </div>
            <div>
                <label for="roads_w">Roads W</label>
                <input type="range" id="roads_w" name="roads_w" min="0" max="100" step="1">
            </div>
            <div>
                <label for="paths_l_min">Paths L Min</label>
                <input type="range" id="paths_l_min" name="paths_l_min" min="0" max="100" step="1">
            </div>
            <div>
                <label for="paths_l_max">Paths L Max</label>
                <input type="range" id="paths_l_max" name="paths_l_max" min="0" max="100" step="1">
            </div>
            <div>
                <label for="paths_w">Paths W</label>
                <input type="range" id="paths_w" name="paths_w" min="0" max="100" step="1">
            </div>
            <div>
                <label for="slope_l_min">Slope L Min</label>
                <input type="range" id="slope_l_min" name="slope_l_min" min="0" max="100" step="1">
            </div>
            <div>
                <label for="slope_l_max">Slope L Max</label>
                <input type="range" id="slope_l_max" name="slope_l_max" min="0" max="100" step="1">
            </div>
            <div>
                <label for="slope_w">Slope W</label>
                <input type="range" id="slope_w" name="slope_w" min="0" max="100" step="1">
            </div>
            <div>
